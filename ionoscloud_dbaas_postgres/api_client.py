...
import ionoscloud_dbaas_postgres.models
from ionoscloud_dbaas_postgres import rest
from ionoscloud_dbaas_postgres.exceptions import ApiValueError, ApiException, ApiFailedRequest, ApiTimeout
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'ionos-cloud-sdk-python/1.0.3'
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ionoscloud_dbaas_postgres.models, klass)
