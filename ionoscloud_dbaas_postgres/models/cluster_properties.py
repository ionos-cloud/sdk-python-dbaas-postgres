...
class ClusterProperties(object):
    ...
    def __init__(self, display_name=None, postgres_version=None, location=None, backup_location=None, instances=None, ram=None, cores=None, storage_size=None, storage_type=None, connections=None, maintenance_window=None, synchronization_mode=None, local_vars_configuration=None):  # noqa: E501
